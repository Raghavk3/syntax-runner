...
public abstract class QuestionBank implements QuestionBankInterface
{
     ...
     *
     * My original idea is adopting 2d array, but apparently HashMap is more handy
     * cuz we need to arrange ID to each question. -- Etienne Gu
     */
    ...
    /**
     * Returns the raw String[][] for the given question id, or null if not found.
     * Used by tooling such as BankValidator.
     *
     * A failed test has occurred during running JudgerTest.
     * Afterward, BankValidator is designed to test the validation of each question in 6 levels of QuestionBank
     * -- Etienne Gu
     */
    public String[][] getRawQuestion(int id) {
        return QUESTIONS.get(id);
    }
